                            ...
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    <div class="card-title text-center">
                                        <h2 class="checkout-title text-uppercase text-center mb-30">LOGIN ADMIN</h2>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal form-simple" action="/login" method="post" novalidate>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                                <input name="email" type="text" class="form-control form-control-lg" placeholder="Nhập vào email" required>
                                                <div class="form-control-position">
                                                    <i class="feather icon-user"></i>
                                                </div>
                                            </fieldset>
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input name="password" type="password" class="form-control form-control-lg" placeholder="Nhập vào mật khẩu" required>
                                                <div class="form-control-position">
                                                    <i class="fa fa-key"></i>
                                                </div>
                                            </fieldset>
