...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="/asset_client/css/bootstrap.min.css">
						...
						<div class="col-lg-2 col-md-4 col-6 align-flax">
				            <div class="navbar-header">
					            <a class="navbar-brand" href="index.html">
					                <img alt="logo" src="/asset_client/images/logo.png" class="transition">
					            </a>
				            </div>
					    </div>
				...
				<div class="container">
					<div class="footer-inner">
						...
						<div class="footer-box footer-contact footer-static m-0">
							...
							<ul class="footer-block-contant">
								<li><img src="/asset_client/images/cont-1.png" alt="img"><span>28 Green Tower, Street Name <br>New York City, USA</span></li>
								<li><img src="/asset_client/images/cont-2.png" alt="img"><a href="tel:+911234567890">+ 91 123 456 789 0</a></li>
								<li><img src="/asset_client/images/cont-3.png" alt="img"><a href="mailto:NICE@example.com">NICE@example.com</a></li>
							</ul>
						</div>
					</div>
					<div class="copy-right mt-100">
						<div class="row">
							<div class="col-xl-6 col-lg-6 col-md-12">
								<p class="copyright-text">&#169; NICE all Rights Reserverd theme by <a href="https://templatescoder.com/" target="_blank">TemplatesCoder</a></p>
							</div>
							<div class="col-xl-6 col-lg-6 col-md-12">
								<ul>
